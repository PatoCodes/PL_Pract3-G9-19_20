...
# Imports necesarios para el funcionamiento adecuado
import componentes
import errores
import flujo
import string
...
class Analex:
  ...
  #  Devuelve: Componente léxico con el tipo de número leído (entero o real)
  #            junto a su valor numérico
  #
  ############################################################################
  ...
  #
  #  Funcion: TrataIdent
  #  Tarea:  Lee identificadores y palabras reservadas
  #  Prametros:  flujo:  flujo de caracteres de entrada
  #              ch: Primer caracter a tratar
  #  Devuelve: Componente léxico apropiado (identificador o palabra reservada)
  #            conteniendo el lexema apropiado
  #
  ############################################################################
  ...
  #
  #  Funcion: TrataBlanco
  #  Tarea:  Lee e ignora caracteres blancos. NO incluye saltos de linea
  #  Prametros:  flujo:  flujo de caracteres de entrada
  #              ch: Primer caracter a tratar
  #  Devuelve: --
  #
  ...
  #
  #  Funcion: TrataComent
  #  Tarea:  Lee e ignora comentarios. NO incluye saltos de linea
  #  Prametros:  flujo:  flujo de caracteres de entrada
  #              ch: Primer caracter a tratar
  #  Devuelve: --
  #
